...
exports.seed = function(knex, Promise) {
  // Deletes ALL existing entries
	return knex.raw('TRUNCATE author CASCADE; ALTER SEQUENCE author_id_seq restart with 1')
    .then(function () {
	...
	return knex('author').insert([
		...
		},
		{
			...
			portrait_url:'https://s3-us-west-2.amazonaws.com/assessment-images/galvanize_reads/photos/allen_b.jpg'
		},
		{
			first_name:'Bonnie',
			last_name:'Eisenman',
